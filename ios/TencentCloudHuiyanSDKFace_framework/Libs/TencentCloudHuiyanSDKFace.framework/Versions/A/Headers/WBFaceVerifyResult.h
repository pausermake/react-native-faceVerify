...
@interface WBFaceCustomizedResult : NSObject
/**
 上报需要使用的aesKey
 */
@property (nonatomic, copy, readonly) NSString *encryptAESKey;
...
/**
 上报需要用的identityStr
 */
@property (nonatomic, copy, readonly) NSString *identityStr;
...
#pragma mark - 专业版SDK返回参数
@property (nonatomic, strong, readonly) WBFaceCustomizedResult *customizedResult;
